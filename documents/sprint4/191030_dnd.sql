...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `NEWS` (
  `NEWS_ID` int(42) NOT NULL AUTO_INCREMENT,
  `NEWS_CAT` varchar(42) NOT NULL,
  `NEWS_TITLE` varchar(42) NOT NULL,
  `NEWS_CONTENT` varchar(3000) NOT NULL,
  `NEWS_AUTHOR` varchar(42) NOT NULL,
...
INSERT INTO `PLAYERS` VALUES (1,1234,'Test'),(2,1235,'Frodo'),(3,1236,'Einstein'),(4,1237,'Morgan'),(5,1238,'Putin'),(6,1239,'Pinkman'),(7,1240,'Snow'),(8,1241,'Merlin');
