...
<!-- Start of Navigation -DC -->
    <nav class="navbar navbar-expand-sm navbar-dark" style="background:black;">
        ...
        <a class="navbar-brand" href="a_index.html"><image src="images/navlogo_text.png" class="img-fluid"></image></a>
            <ul class="navbar-nav">
                ...
                <li class="nav-item p-2">
                    <a class="nav-link" href="index.html"><h3 class="font-weight-bold">Logout</h3></a>
                </li>
            </ul>
        </div>
    </nav>
