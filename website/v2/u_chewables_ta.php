...
$unit_query = "SELECT * FROM CHEWABLES";
...
<!-- Start of Navigation -DC -->
    <nav class="navbar navbar-expand-sm navbar-dark" style="background:black;">
        ...
        <a class="navbar-brand" href="index.html"><image src="images/navlogo_text.png" class="img-fluid"></image></a>
            <ul class="navbar-nav">
                ...
                <li class="nav-item p-2">
                    <a class="nav-link" href="a_login.html"><h3 class="font-weight-bold">Admin Login</h3></a>
                </li>                
            </ul>
        </div>
    </nav>
    ...
    <div style="background:black;">
        ...
        <br>
        <br>
        <h1 class="text-white text-center font-weight-bold">This is the User Chewables View</h1>
        <br>
        <br>
        <br>

        <!-- Start of The User View Chewables Body -DC -->      
...
if ($unit_results->num_rows > 0) {
        ...
        while($rowc = $unit_results->fetch_assoc()) 
        {
            ...
            <div class="row pb-5 pt-5"><div class="col-sm-12 text-center rounded bg-primary"><h2 class="text-black font-weight-bold">'.$unit_name.'</h2></div></div>
            </div>';
