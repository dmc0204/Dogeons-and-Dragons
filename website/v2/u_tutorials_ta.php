...
$unit_query = "SELECT * FROM TUTORIALS";
...
<!-- Start of Navigation -DC -->
    ...
    <div style="background:black;">
        ...
        <br>
        <br>
        <h1 class="text-white text-center font-weight-bold">This is the User Tutorials View</h1>
        <br>
        <br>
        <br>

        <!-- Start of The User View Tutorials Body -DC -->      
